...
% \`E relativamente buono il valore della $ HL $: il modello sembra
% apprendere delle differenze sensate; l'EMR mostra invece come
% il modello non sia praticamente mai in grado di ottenere una classificazione
% perfetta di tutte le label correttamente.
...
classi.
% per verificare le capacità di un modello di
% questo tipo sul dataset in questione.
